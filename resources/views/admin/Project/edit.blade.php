                ...
                <div class="card-body">
                  <div class="row">
                            <div class="col">
                              ...
                              <input name="name" type="name" placeholder="name" pattern="[a-zA\s]{0,15}" id="name" value="{{$pj->name}}" >
                            </div>
                              <div class="col">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="description" id="description" placeholder="Enter Description" value="{{$pj->description}}" >
                  </div>
                  <div class="form-group">
                    ...
                    <input class="form-control" name="content" id="content" placeholder="Enter Content">
                          ...
                          <div class="container1" >
                              <div class="item">
                                ...
                                <input type="text" name="date_start"  id="date_start" value="{{$pj->date_start}}" >
                              </div>
                              <div class="item1">
                                <label for="exampleInputEmail1">Ngày kết thúc</label> <br/>
                                <input type="text" name="date_end"  id="date_end" value="{{$pj->date_end}}" >
                              </div>
                          </div>
                </div>
